...
public class DebugBlockContainer extends AbstractContainerMenu {
    ...
    // Server constructor
    public DebugBlockContainer(int id, Inventory playerInv, IItemHandler slots, BlockPos pos) {
    ...
    public static MenuConstructor getServerContainer(DebugBlockEntity chest, BlockPos pos) {
        return (id, playerInv, player) -> new DebugBlockContainer(id, playerInv, chest.inventory, pos);
    }
}
